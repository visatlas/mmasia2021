      ...
      <nav className="bg-mainPurple fixed top-0 z-50 w-full lg:px-10 md:bg-uqStyle">
        ...
        <div className={showMobileMenu ? "md:hidden" : "hidden"} id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <button className={mobileCallsStyle} onClick={() => { setShowMobileCalls(!showMobileCalls); }}>Calls...</button>
            {showMobileCalls && (<div>
    ...
    <div className="group dropdown inline-block relative">
      ...
      <div className="dropdown-menu absolute hidden text-gray-800 pt-1 w-60"> {/* hidden */}
        <div className="rounded shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5">
          ...
          whitespace-no-wrap text-orgSmall" title="Call for Workshops">Call for <span className="font-medium">Workshops</span></Link>
          <Link to="/call-for-demo-papers" className="font-headingStyle bg-white hover:bg-gray-100 py-2 px-4 block 
          whitespace-no-wrap text-orgSmall" title="Call for Demo Papers">Call for <span className="font-medium">Demo Papers</span></Link>
          <Link to="/call-for-short-papers" className="font-headingStyle bg-white hover:bg-gray-100 py-2 px-4 block 
          whitespace-no-wrap text-orgSmall" title="Call for Short Papers">Call for <span className="font-medium">Short Papers</span></Link>
        </div>
      </div>
    </div>
  );

        ...
        <div className="max-w-7xl mx-auto px-0 lg:px-12 h-full">
          <div className="w-full sm:w-148 bg-gray-100 bg-opacity-90 p-8 sm:p-12 pt-16 h-full overflow-auto" >
            ...
            <p className="mt-2 mb-4 text-red-900 text-xs inline-block font-semibold rounded-md leading-5">
              For any issues and enquires, please contact mmasia2021@gmail.com.
            </p>
            <form className="pt-3" method="post" onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input className="appearance-none rounded w-full py-2 px-3 text-gray-700 bg-gray-50 
                  leading-tight focus:outline-none focus:shadow-outline" name="username" type="text"
                  placeholder="user@example.com" onChange={e => setUsername(e.target.value)} />
              </div>
              <div className="mb-5">
                ...
                <input className="appearance-none rounded w-full py-2 px-3 text-gray-700 bg-gray-50 mb-3 
                  leading-tight focus:outline-none focus:shadow-outline" name="pin" type="password"
              ...
              <p className="text-sm text-gray-600 font-medium leading-6 mb-8">
                ...
                including keeping you logged in and remembering your preferences.
              </p>
              <div className="flex items-center gap-2">
                <input className={inputStyle} type="submit" value={submitting ? "Signing In..." : "Sign In"}
                  disabled={submitting} />
                <Link to="/registration" title="Conference Registration"
                  className="hover:underline py-2 px-4 font-medium">Sign Up</Link>
              </div>
            </form>
          </div>
        </div>

          ...
          <section className="w-full lg:w-2/3 py-4 pl-4 pr-4 lg:pl-8 lg:pr-12">
            <article className="text-justify flex flex-col">
              ...
              <ul className="list-disc list-inside">
                <li className="mb-2"><strong>Xiaofang Zhou</strong> <address><a href="zxf@itee.uq.edu.au">email</a></address>, <br>Hong Kong University of Science and Technology, China</li>
                <li className="mb-6"><strong>Bing-Kun Bao</strong> <address><a href="bingkunbao@njupt.edu.cn">email</a></address>, <br>Nanjing University of Posts and Telecommunications, China</li>
              </ul>
